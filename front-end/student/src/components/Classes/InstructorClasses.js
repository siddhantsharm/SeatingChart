/* Styling for Instructor Classes page. Lists class cards for each class the instructor teaches. */

import React from "react";
import clsx from "clsx";
import { makeStyles } from "@material-ui/core/styles";
import ClassCards from "../ClassCards/InstructorCards.js";
  ...
  for (var i = 0; i < currentUser.classes.length; i += 1) {
    cards.push(
      <Paper className={fixedHeightPaper}>
        <ClassCards courseName={currentUser.classes[i]} />
      </Paper>
    );
